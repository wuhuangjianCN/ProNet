using CUDA,ProNetM,CUDA,Dates,DataFrames,Statistics,TimeZones,JLD2,Flux,MLUtils,ProgressMeter
...
epoch=50
expName="PureAIS"
outputFolder="$(pInfo.dataFolder)/outputs/$(expName)/ensemble_v23_9"
# fileFun_model(epoch)="$(outputFolder)/model_epoch$(epoch).jld2"
# outputFolder="$(pInfo.dataFolder)/outputs/Emean_V0"
...
for tStart_file in tStart_file_all
    # tStart_file=tStart_file_all[1]
    # tStart_curr=tStart_file + mInfo.leads_all
