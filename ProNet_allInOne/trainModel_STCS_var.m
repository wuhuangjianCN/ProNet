function [para_st,para_cs,hf1]=trainModel_STCS_var(xVarName_st,fileName_dlX_stInit,fileName_dlX_st,fileName_dlY_stTarget,fileName_stLossWeight,para_st,state_st,csDataFun,meshCSInCell,para_cs,option)
...
%     absLossRatio=0.1;
    loss =sum((weight.*(...
        abs(dlY_st-dlY_target)+abs(dlY-dlY_target)...
